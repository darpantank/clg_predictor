...
<head>
  ...
  <title>ACPC Merit Checker</title>
  <style>
    * {
      margin: 0;
      padding: 0;
...
<body>
  <h1 font="Forte" class="text-justify bg-dark my-0 text-light text-lg-center">MyMerit Checker <br>(For Engineering
  ...
  <h5 class="text-justify bg-dark my-0 text-light text-lg-center">This Website May Help You to Find Engineering
    College's In Gujarat With Respect Of Your Merit...</h5>
  <hr color="white" class="my-0">
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="mailto:darpantank@yahoo.com">Contatct Us</a>
        </li>
  ...
  <div class="container-fluid my-3">
    <form action="/merit/index.php" method="POST">
  ...
  <div class="container-fluid my-3">
    ...
    if($_SERVER['REQUEST_METHOD']=='POST')
    {
        ...
        if($category=="DS")
        {
          if($branch=='All')
          {
            $query= "SELECT * FROM `merit` WHERE `dsrank`>'$merit' ";
            $result= @mysqli_query($conn,$query);
           ...
           {
            $query= "SELECT * FROM `merit` WHERE `dsrank`>'$merit' AND `course`='$branch'";
            $result= @mysqli_query($conn,$query);
  ...
  <div class="container-fluid my-3">
    ...
    Here You Can't Find Vacant college Name...
